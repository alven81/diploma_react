        ...
        <li className="reviews_main">
            <div className="reviews_main-image">
                <Link key={productId.id} to={`/product/${productId.id}`}>
                    <img 
                        onClick={() => {dispatch(addItemIndex(productId.id));
                        <Product />}}
                        src={`http://localhost:3000${productId.image}`} alt=""/>
                </Link>     
                <p>
                        {review.data}
                </p>    
            ...
            <div className="reviews_main-price">
                ...
                <p className={productId.discount === true ? "discount" : "hide"}>
