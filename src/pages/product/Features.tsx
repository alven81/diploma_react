    ...
    return (
        <>
            ...
            <div className={(features.weight) ? "" : "hide"}>
                <p>Вес товара с упаковкой (г)</p><em></em><span>{features.weight}</span>
            </div>
            ...
            <div className={(features.height_gross) ? "" : "hide"}>
                <p>Высота упаковки (см)</p><em></em><span>{features.height_gross}</span>
            </div>
            <div className={(features.deep) ? "" : "hide"}>
                <p>Глубина упаковки (см)</p><em></em><span>{features.deep}</span>
            </div>
            <div className={(features.width) ? "" : "hide"}>
                <p>Ширина упаковки (см)</p><em></em><span>{features.width}</span>
            </div>
            <div className={(features.height) ? "" : "hide"}>
                <p>Высота изделия (см)</p><em></em><span>{features.height}</span>
            </div>
            <div className={(features.creation.length) ? "" : "hide"}>
