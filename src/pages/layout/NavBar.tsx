				...
				<div className="nav_bottom">
					...
					<div>
						<ul className="nav_bottom-list">
							...
							<li>
								<NavLink className="nav_bottom-list" to="craft">
									Рукоделие
								</NavLink>
							</li>
							<li>
								<NavLink className="nav_bottom-list" to="paint">
									Рисование
								</NavLink>
							</li>
							<li>
								<NavLink className="nav_bottom-list" to="model">
									Моделирование
								</NavLink>
							</li>
							<li>
								<NavLink className="nav_bottom-list" to="decor">
									Украшение
								</NavLink>
							</li>
							<li>
								<NavLink className="nav_bottom-list" to="flora">
									Флористика
								</NavLink>
							</li>
							<li>
